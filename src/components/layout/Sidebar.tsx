    ...
    <>
      ...
      >
        ...
        <div className={cn("h-16 flex items-center border-b border-white/10 transition-all duration-300", isCollapsed ? "justify-center px-0" : "px-6 gap-3")}>
          <div className="p-1.5 bg-primary-600/20 rounded-lg border border-primary-500/30 shrink-0">
        ...
        <nav className="flex-1 p-3 space-y-1 overflow-y-auto overflow-x-hidden">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <item.icon className={cn("w-5 h-5 shrink-0 transition-colors", isActive ? "text-primary-400" : "group-hover:text-white")} />
        ...
        <div className="p-4 border-t border-white/10">
          <div className={cn("flex items-center gap-3 p-2 rounded-xl bg-white/5 border border-white/5 transition-all duration-300", isCollapsed ? "justify-center" : "")}>
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center text-white font-bold shrink-0 text-xs">
